...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#0a0a0a] text-center px-6">
      <h1 className="text-[#FF991C] text-9xl font-black mb-4">404</h1>
      ...
      <Link
        href="/"
        className="px-8 py-3 bg-[#FF991C] text-white font-bold uppercase tracking-widest text-sm hover:bg-[#E68A19] transition-all"
      >
        Return Home
      </Link>
    </div>
